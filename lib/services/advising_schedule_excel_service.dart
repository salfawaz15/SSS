...
class AdvisingScheduleExcelService {
  ...
  // أسماء الأيام الفعلية بدل "اليوم الأول/الثاني/الثالث" العامة السابقة -
  // كل الأقسام الخمسة توزّع الإرشاد فعليًا على نفس هذه الأيام الثلاثة
  // (تحقَّق من بيانات فعلية 2026-08-10)، وتسمية اليوم الحقيقي ضرورية لعرض
  // الجدول بترتيب منطقي (كان يظهر "اليوم الأول" بلا معنى فعلي بصفحة العرض).
  static const List<String> dayColumnLabels = ['الأحد', 'الاثنين', 'الثلاثاء'];
  static const List<String> periodOptions = ['الفترة الأولى', 'الفترة الثانية', 'الفترة الثالثة'];

  // أوقات الفترتين المستخدَمتين فعليًا (سليمان 2026-08-24، بالاعتماد على
  // جداول فعلية مرفوعة: "الفترة الأولى (8:00 ص - 11:00 ص)"، "الفترة الثانية
  // (11:00 ص - 2:00 م)") - ثابتة لكل الأيام والأقسام. لا وقت معروف للفترة
  // الثالثة (غير مستخدَمة فعليًا حسب سليمان: "هي فترتان وليست ثلاث")، فتبقى
  // بلا وقت إضافي إن ظهرت.
  static const Map<String, String> _periodTimes = {
    'الفترة الأولى': '8:00 ص - 11:00 ص',
    'الفترة الثانية': '11:00 ص - 2:00 م',
  };

  /// اسم الفترة مع وقتها بجانبه (مثال: "الفترة الأولى (8:00 ص - 11:00 ص)")
  /// - يُستخدَم بكل مكان يُعرض فيه اسم الفترة (بطاقات الواجهة وملفات PDF)
  /// بدل الاسم المجرَّد بلا وقت.
  static String periodDisplayLabel(String periodLabel) {
    final time = _periodTimes[periodLabel];
    return time == null ? periodLabel : '$periodLabel ($time)';
  }
