...
class CourseCatalog {
  ...
  /// متطلبات ومقررات خارج الكلية (إجباري/اختياري) - لا تظهر في ملف "الحويّة"
  /// الخاص بالكلية لأنها تُدرَّس عبر كليات أخرى، لذا لا مصدر تلقائي حي لها
  /// كبقية المقررات ولا بد من تحديثها هنا يدويًا عند تغيّر الخطة. متطابقة
  /// حاليًا بين شطري الطلاب والطالبات.
