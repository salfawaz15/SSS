...
class HardshipCasesCoordinatorScreen extends StatefulWidget {
  final String shatr;
  final String department;

  const HardshipCasesCoordinatorScreen({
    super.key,
    required this.shatr,
  ...
  @override
  State<HardshipCasesCoordinatorScreen> createState() => _HardshipCasesCoordinatorScreenState();
}

class _HardshipCasesCoordinatorScreenState extends State<HardshipCasesCoordinatorScreen> {
            ...
            ElevatedButton(
              onPressed: isSaving
                  ...
                  : () async {
                      ...
                      await HardshipCaseService.addCase(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: isSaving
                  ...
                  : () async {
                      setDialogState(() => isSaving = true);
                      await HardshipCaseService.addFollowUp(
                        caseId: c.id,
                        status: selected,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<HardshipCase>>(
        stream: HardshipCaseService.watchDepartmentCases(
          shatr: widget.shatr,
          department: widget.department,
        ),
          ...
          if (cases.isEmpty) {
            return Center(
              child: Padding(
                ...
                child: Text(
                  'لا توجد حالات مسجَّلة بعد لقسمك.',
