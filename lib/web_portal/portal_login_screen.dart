...
class _PortalLoginScreenState extends State<PortalLoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // بلا سهم رجوع إطلاقًا لو ما فيه شيء يُرجَع له فعليًا - بالنسخة
      // المتجاوبة لموقع الجوال هذه الشاشة قد تُعرَض كجذر مباشرة لمن لم
      // يسجّل دخوله بعد (بلا صفحة تعريفية قبلها)، فكان السهم يظهر نشطًا لكنه
      // لا يفعل شيئًا (`maybePop` على شاشة جذر
