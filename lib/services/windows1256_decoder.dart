/// فك ترميز Windows-1256 (الترميز العربي المستخدم في تصدير Oracle Reports
/// كملفات .xls التي هي فعليًا HTML) - Dart لا يملك محوّلًا مدمجًا لهذا الترميز.
  ...
  static String decode(List<int> bytes) {
    ...
    for (final b in bytes) {
      if (b < 0x80) {
        ...
        buffer.writeCharCode(_upperHalf[b - 0x80]);
      }
    }
