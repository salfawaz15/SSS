...
class AdvisingLoadRules {
  ...
  static const List<String> _frozenKeywords = [
    ...
    'مجاز',
    'مجازة',
    // "مطوي القيد" كان يُعامَل سابقًا كوفاة فيُحذَف العضو كليًا من الملف
    // (college_roster_parser_service.dart) - افتراض خاطئ صحّحه سليمان
    // صراحةً (2026-08-14): بشرى جمال بكر عمر حالتها "مطوي قيدها" وهي على
    // قيد الحياة (نُقلت إداريًا)، فاختفت من كل شاشات الموقع بلا أي أثر رغم
    // وجود طلاب مسنَدين لها فعليًا. أُزيل الحذف التام وأصبحت تُعامَل كحالة
    // مجمَّدة عادية (كمعار/مجاز) - تبقى ظاهرة في كل القوائم، وطلابها ينتقلون
    // تلقائيًا لـ"على غير مرشدهم" بدل الاختفاء الصامت.
    'مطوي',
  ];
